            ...
            <Card.Body>
              <Card.Text>
                <p>
                  ...
                  challenge, he's up to the task. And he can double as a writer
                  for humor magazines
                </p>
                <p>
                  An inquisitive person with a wide range of interests. He
                  thinks its time to stir up the health sector with the release
                  of new consumer tech especially wearables
                </p>
              </Card.Text>
            </Card.Body>
            <ListGroup className="list-group-flush">
              ...
              <ListGroup.Item>
                Co founder of Scrambled Eggs Ltd, a moderately successful mobile
          ...
          <Row style={{ paddingTop: 10 }} className="justify-content-md-center">
            <Col md="auto" className="text-center">
              <a href="https://github.com/vebnz/owlephant-site">
                <Button className="btn-theme"variant="primary" size="lg" block>
